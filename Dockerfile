...
WORKDIR /root/saltbox-frontend-gateway/
...
FROM $SERVE_IMAGE
LABEL name='saltbox-frontend-gateway' version='1.0'
COPY --from=builder /root/saltbox-frontend-gateway/dist/ /srv/saltbox-frontend-gateway
